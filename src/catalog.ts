...
export const CATALOG: CatalogEntry[] = [
  ...
  { id: "B3", category: "Activities", name: "Retrying a step doesn't repeat its effect", engine: "dynamic-fixture" },
  ...
  { id: "C1", category: "Signals, Queries & Updates", name: "Signals are received correctly, including duplicates and late ones", engine: "dynamic-fixture" },
  { id: "C2", category: "Signals, Queries & Updates", name: "Queries never change anything", engine: "dynamic-fixture" },
  { id: "C3", category: "Signals, Queries & Updates", name: "Invalid updates are rejected before anything changes", engine: "dynamic-fixture", requiresFeatureFlag: "updates" },
  { id: "C4", category: "Signals, Queries & Updates", name: "Update-with-Start doesn't create duplicates", engine: "dynamic-fixture", requiresFeatureFlag: "updateWithStart" },
  { id: "C5", category: "Signals, Queries & Updates", name: "Signal/update handling doesn't get the workflow stuck", engine: "dynamic-fixture" },

  // D. Timers & Scheduling
  { id: "D1", category: "Timers & Scheduling", name: "Waiting/timers behave consistently", engine: "dynamic-zero-fixture" },
  { id: "D2", category: "Timers & Scheduling", name: "Scheduled (recurring) workflows fire at the right time", engine: "dynamic-fixture", requiresFeatureFlag: "schedules" },
  { id: "D3", category: "Timers & Scheduling", name: "Overlapping scheduled runs are handled correctly", engine: "dynamic-fixture", requiresFeatureFlag: "schedules" },
  { id: "D4", category: "Timers & Scheduling", name: "Missed scheduled runs are handled correctly after downtime", engine: "dynamic-fixture", requiresFeatureFlag: "schedules" },
  ...
  { id: "E2", category: "Long-Running Workflows", name: "Nothing is lost when the workflow resets itself", engine: "dynamic-fixture" },

  // F. Child Workflows & Cross-Service Calls
  { id: "F1", category: "Child Workflows & Cross-Service Calls", name: "A failing child workflow is handled correctly by its parent", engine: "dynamic-fixture", requiresFeatureFlag: "childWorkflows" },
  { id: "F2", category: "Child Workflows & Cross-Service Calls", name: "Child workflows don't get orphaned", engine: "dynamic-fixture", requiresFeatureFlag: "childWorkflows" },
  ...
  { id: "G1", category: "Multi-Step Failure Handling (Saga Pattern)", name: "A mid-process failure doesn't leave things half-done", engine: "dynamic-fixture" },
  ...
  { id: "H1", category: "Cancellation & Termination", name: "Cancel runs cleanup", engine: "dynamic-fixture" },
  { id: "H2", category: "Cancellation & Termination", name: "Terminate skips cleanup (on purpose)", engine: "dynamic-zero-fixture" },
  { id: "H3", category: "Cancellation & Termination", name: "Cancelling a parent also handles its children/activities correctly", engine: "dynamic-fixture", requiresFeatureFlag: "childWorkflows" },
  ...
  { id: "J2", category: "Observability", name: "Custom search/filter fields work", engine: "dynamic-fixture", requiresFeatureFlag: "searchAttributes" },
  ...
  { id: "K2", category: "Data & Security", name: "Sensitive data isn't exposed in plain text", engine: "dynamic-fixture" },
  ...
  { id: "L2", category: "Resilience to Outages", name: "A dependency outage doesn't lose work", engine: "dynamic-fixture" },
